...
<head>
    ...
    <!--switchery-->
    <link href="{{ Request::root().'/js/switchery/switchery.min.css'}}" rel="stylesheet" type="text/css" media="screen" />

    <!--Form Wizard-->
    <link rel="stylesheet" type="text/css" href="{{ Request::root().'/css/jquery.steps.css' }}" />

    <!--common style-->
    <link href="{{ Request::root().'/css/style.css' }}" rel="stylesheet">
    <link href="{{ Request::root().'/css/style-responsive.css' }}" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="{{ Request::root().'/css/custom.css'}}">
    @if( \Request::path() == 'privacy' || \Request::path() == 'datatable' || \Request::path() == 'services')
      <link rel="stylesheet" href="{{ Request::root().'/css/helper.css' }}" media="screen" title="no title" charset="utf-8">
